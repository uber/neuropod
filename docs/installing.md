...
curl -L https://github.com/uber/neuropod/releases/download/v0.3.0-rc3/libneuropod-gpu-cuda-10.1-linux-v0.3.0-rc3-torchscript-1.7.0-backend.tar.gz | sudo tar -xz -C "$NEUROPOD_BASE_DIR"
```
