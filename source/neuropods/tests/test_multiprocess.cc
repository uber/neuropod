...
TEST(test_multiprocess_backend, test_pytorch_addition_model)
{
    ...
    auto neuropod = neuropods::load_neuropod_in_new_process("neuropods/tests/test_data/pytorch_addition_model/");
...
TEST(test_multiprocess_backend, test_torchscript_addition_model)
{
    ...
    auto neuropod = neuropods::load_neuropod_in_new_process("neuropods/tests/test_data/torchscript_addition_model/");
    test_addition_model(*neuropod);
}
...
TEST(test_multiprocess_backend, test_tensorflow_addition_model)
{
    ...
    auto neuropod = neuropods::load_neuropod_in_new_process("neuropods/tests/test_data/tf_addition_model/");
    test_addition_model(*neuropod);
}
