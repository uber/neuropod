...
# Set default value to sys.argv to fix https://github.com/uber/neuropod/issues/374
if not hasattr(sys, 'argv') and (sys.version_info.major == 3 and sys.version_info.minor < 8):
    sys.argv = ['']
