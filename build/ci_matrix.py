...
GH_ACTIONS_YML = GH_ACTIONS_TEMPLATE + "".join(gh_actions_matrix)
DOCKER_COMPOSE_TEST = DOCKER_COMPOSE_TEST_TEMPLATE + "".join(docker_compose_matrix)
BUILDKITE_YML = BUILDKITE_YML_TEMPLATE + "".join(buildkite_yml_matrix)
